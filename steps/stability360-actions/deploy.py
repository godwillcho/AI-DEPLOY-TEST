...
CASE_CUSTOM_FIELDS = [
    ...
    ('Housing Label', 'housingLabel'),
    ('Employment Score', 'employmentScore'),
    ('Employment Label', 'employmentLabel'),
    ('Financial Resilience Score', 'financialResilienceScore'),
    ('Financial Label', 'financialLabel'),
    ('Composite Score', 'compositeScore'),
    ('Composite Label', 'compositeLabel'),
    ('Priority Flag', 'priorityFlag'),
    ('Priority Meaning', 'priorityMeaning'),
    ('Recommended Path', 'recommendedPath'),
    ('Path Meaning', 'pathMeaning'),
    ('Scoring Summary', 'scoringSummary'),
    ('Call Disposition', 'callDisposition'),
    ('Preferred Days', 'preferredDays'),
    ('Preferred Times', 'preferredTimes'),
    ('Eligible BCDCOG', 'eligibleBCDCOG'),
    ('Eligible Siemer', 'eligibleSiemer'),
    ('Eligible Mission United', 'eligibleMissionUnited'),
    ('Eligible Barriers To Employment', 'eligibleBarriersToEmployment'),
]
